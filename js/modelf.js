...
var PosFlag = {
    '寝室': new Position('寝室', [20, 20], [200, 100], 0.01),
    '超市': new Position('超市', [20, 140], [200, 100], 0.005),
    '教室': new Position('教室', [20, 260], [200, 100], 0.007),
    '食堂': new Position('食堂', [240, 20], [200, 100], 0.008),
    '操场': new Position('操场', [240, 140], [200, 100], 0.0005),
    '图书馆': new Position('图书馆', [240, 260], [200, 100], 0.006)
}
PosFlag['寝室'].initRoom();
PosFlag['教室'].initClass();
let Divide = new Position('隔离区', [460, 140], [100, 100], 0)
