...
function Position(name, position, area, StouchNum, infect, transition = 1 / 5.2, recover = 1 / 18) {
    this.name = name;
...
function init_number() {
    ...
    PosFlag = {
        '寝室': new Position('寝室', [stepwidth, stepheight], [(widthk - stepwidth * 4) / (2 + DivideP), (heightk - stepheight * 4) / 3], TouchPeopleNum, init_infected),
        '超市': new Position('超市', [stepwidth, (heightk - stepheight * 4) / 3 + 2 * stepheight], [(widthk - stepwidth * 4) / (2 + DivideP), (heightk - stepheight * 4) / 3], TouchPeopleNum, init_infected),
        '教室': new Position('教室', [stepwidth, 2 * (heightk - stepheight * 4) / 3 + 3 * stepheight], [(widthk - stepwidth * 4) / (2 + DivideP), (heightk - stepheight * 4) / 3], TouchPeopleNum, init_infected),
        '餐厅': new Position('餐厅', [(widthk - stepwidth * 4) / (2 + DivideP) + 2 * stepwidth, stepheight], [(widthk - stepwidth * 4) / (2 + DivideP), (heightk - stepheight * 4) / 3], TouchPeopleNum, init_infected),
        '操场': new Position('操场', [(widthk - stepwidth * 4) / (2 + DivideP) + 2 * stepwidth, (heightk - stepheight * 4) / 3 + 2 * stepheight], [(widthk - stepwidth * 4) / (2 + DivideP), (heightk - stepheight * 4) / 3], TouchPeopleNum, init_infected),
        '图书馆': new Position('图书馆', [(widthk - stepwidth * 4) / (2 + DivideP) + 2 * stepwidth, 2 * (heightk - stepheight * 4) / 3 + 3 * stepheight], [(widthk - stepwidth * 4) / (2 + DivideP), (heightk - stepheight * 4) / 3], TouchPeopleNum, init_infected)
    };
...
function s() {
    ...
    for (let cnt = 1; cnt <= 104; ++cnt) {
        ...
        for (var i in PosFlag) {
            ...
            // // console.log(cnt, PosFlag[i], Expose);
                ...
                if (PersonData[i].mark == 2) {
                    if (PersonData[i].status == 'student') {
                        for (let j = (parseInt(PersonData[i].RoomNum) - 1) * 5; j < parseInt(PersonData[i].RoomNum) * 5; ++j) {
                            ...
                            // if (PersonData[j].mark == 1) {
                            //     Divide.ePos.push(PersonData[j])
                            //     Divide.e++;
                            //     Divide.PeopleType[PersonData[j].status]++;
                            // } else if (PersonData[j].mark == 0) {
                            //     Divide.sPos.push(PersonData[j]);
                            //     Divide.s++;

                            // } else if (PersonData[j].mark == 2) {
                            //     Divide.j++;
                            //     Divide.PeopleType[PersonData[j].status]++;
                            //     Divide.iPos.push(PersonData[j]);
                            // } else if (PersonData[j].mark == 3) {
                            //     Divide.r++;
                            // }
                        }
                    } else {
        ...
        // for (let k in Divide.people) {
        //     // // console.log(Divide.people[k])
        //     if (Divide.people[k].mark == 0) {
        //         Divide.s++;
        //     } else if (Divide.people[k].mark == 1) {
        //         Divide.e++;
        //     } else if (Divide.people[k].mark == 2) {
        //         Divide.i++;
        //     } else {
        //         Divide.r++;
        //     }
